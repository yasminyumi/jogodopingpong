...
procedure colisaogol1;
var
corpo1:integer;
begin
corpo1:= form1.bola.left + form1.bola.Width;
if corpo1 >= form1.gol1.left then
begin
form1.moverdireita.enabled := true;
form1.moveresquerda.enabled := false;
end;
end;
